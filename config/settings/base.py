...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="sistemaovo"),
        "USER": config("DB_USER", default="sistemaovo"),
        "PASSWORD": config("DB_PASSWORD", default="sistemaovo"),
